...
namespace SkinForm
{
    ...
    public class SkinForm : Form
    {
        ...
        protected SkinFormRenderer _renderer;
        ...
        protected Color _captionBackColor = Color.Transparent;
        protected Image _captionBackImage = null;
        ...
        public virtual SkinFormRenderer Renderer
        {
            get
            {
                if (_renderer == null)
        ...
        public override string Text
        {
            ...
            set
            {
                ...
                {
                    base.Text = value;
                    base.Invalidate(new Rectangle(0, 0, Width, CaptionHeight + 1));
                }
            }
        }

        [DefaultValue(typeof(RoundStyle),"1"),Description("窗体圆角类型")]
        ...
        [DefaultValue(8),Description("窗体圆角半径")]
        public int Radius
        {
            get { return _radius; }
            set
        ...
        [DefaultValue(24),Description("标题栏高度")]
        public int CaptionHeight
        {
            ...
            set
            {
                ...
                {
                    _captionHeight = value < _borderWidth ? _borderWidth : value;
                    base.Invalidate();
                }
            }
        }
        ...
        public Color CaptionBackColor
        {
            ...
            set
            {
                if (value == null)
                {
                    _captionBackColor = Color.Transparent;
                }
                else
                {
        ...
        public Image CaptionBackImage
        {
            ...
            set
            {
                if (this._captionBackImage != value)
                {
                    this._captionBackImage = value;
                    base.Invalidate();
                }
            }
        }
        ...
        internal virtual  Rectangle IconRect
        {
            get
            {

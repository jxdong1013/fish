...
{
    public  class ProductExEntity
    {
        public ProductExEntity()
		{}
		#region Model
		private int _id;
        ...
        private string _confirmarrivedate;
        ...
        /// 
        /// </summary>
        public string confirmarrivedate
        {
            get { return _confirmarrivedate; }
            set { _confirmarrivedate = value; }
        }

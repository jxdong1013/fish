    ...
    public class StorageReportDao
    {
        ...
        public FishEntity.ProductEntity DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                {
                    model.quote_tvn = int.Parse(row["quote_tvn"].ToString());
                }
                ...
                {
                    model.quote_amine = int.Parse(row["quote_amine"].ToString());
                }
                ...
                {
                    model.label_tvn = int.Parse(row["label_tvn"].ToString());
                }
                ...
                {
                    model.label_amine = int.Parse(row["label_amine"].ToString());
                }

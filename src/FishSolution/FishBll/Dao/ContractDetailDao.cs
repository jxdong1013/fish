...
namespace FishBll.Dao
{
    public class ContractDetailDao
    {
		...
		public int Add(FishEntity.ContractDetailEntity model)
		{
            ...
            strSql.Append("contractid,no,productid,productno,productname,specification,weight,quantity, unitprice,money,getweight,getquantity,isfinished)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,contractid,no,productid,productno,productname,specification,weight,quantity,unitprice,money,getweight,getquantity,isfinished ");

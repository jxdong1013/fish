...
namespace FishBll.Dao
{
    public class CheckRecordDao
    {
		...
		public int Add(FishEntity.CheckRecordEntity model)
		{
			...
			parameters[9].Value = model.regularindex1;
			parameters[10].Value = model.regularindex2;
			parameters[11].Value = model.regularindex3;
			parameters[12].Value = model.regularindex4;
			parameters[13].Value = model.regularindex5;
			parameters[14].Value = model.regularindex6;
			parameters[15].Value = model.regularindex7;
			parameters[16].Value = model.regularindex8;
			parameters[17].Value = model.regularindex9;
			parameters[18].Value = model.regularindex10;
			parameters[19].Value = model.regularindex11;
			parameters[20].Value = model.regularindex12;
			parameters[21].Value = model.aminoindex1;
			parameters[22].Value = model.aminoindex2;
			parameters[23].Value = model.aminoindex3;
			parameters[24].Value = model.aminoindex4;
			parameters[25].Value = model.aminoindex5;
			parameters[26].Value = model.aminoindex6;
			parameters[27].Value = model.aminoindex7;
			parameters[28].Value = model.aminoindex8;
			parameters[29].Value = model.aminoindex9;
			parameters[30].Value = model.aminoindex10;
			parameters[31].Value = model.aminoindex11;
			parameters[32].Value = model.aminoindex12;
			parameters[33].Value = model.aminoindex13;
			parameters[34].Value = model.aminoindex14;
			parameters[35].Value = model.aminoindex15;
			parameters[36].Value = model.aminoindex16;
			parameters[37].Value = model.aminoindex17;
			parameters[38].Value = model.aminoindex18;
			parameters[39].Value = model.aminoindex19;
			parameters[40].Value = model.aminoindex20;
			parameters[41].Value = model.aminoindex21;
			parameters[42].Value = model.aminoindex22;
			parameters[43].Value = model.aminoindex23;
			parameters[44].Value = model.specialindex1;
			parameters[45].Value = model.specialindex2;
			parameters[46].Value = model.specialindex3;
			parameters[47].Value = model.specialindex4;
			parameters[48].Value = model.specialindex5;
			parameters[49].Value = model.fee;
		...
		public FishEntity.CheckRecordEntity GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,productid,productcode,productname,recordno,checkdate,testdate,testcompanyid,testcompanycode,testcompanyname,regularindex1,regularindex2,regularindex3,regularindex4,regularindex5,regularindex6,regularindex7,regularindex8,regularindex9,regularindex10,regularindex11,regularindex12,aminoindex1,aminoindex2,aminoindex3,aminoindex4,aminoindex5,aminoindex6,aminoindex7,aminoindex8,aminoindex9,aminoindex10,aminoindex11,aminoindex12,aminoindex13,aminoindex14,aminoindex15,aminoindex16,aminoindex17,aminoindex18,aminoindex19,aminoindex20,aminoindex21,aminoindex22,aminoindex23,specialindex1,specialindex2,specialindex3,specialindex4,specialindex5,fee from t_checkrecord ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};

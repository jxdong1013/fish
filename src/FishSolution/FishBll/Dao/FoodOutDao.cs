...
namespace FishBll.Dao
{
    public class FoodOutDao
    {
		...
		public int Add(FishEntity.FoodOutEntity model)
		{
            ...
            strSql.Append("code,productdate,outdate,productid,productcode,productlabel,weight,package,remark,createman,createtime,modifyman,modifytime,cost,deliverymanid,deliveryman,solutionid,salemanid,saleman,indate,companyid,companycode,companyname)");

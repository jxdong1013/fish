...
namespace FishBll.Dao
{
    public class CustomerDao
    {
		...
		public int Add(FishEntity.CustomerEntity model)
		{
            ...
            strSql.Append("code,name,currentlinkDate,telephone,phone1,phone2,phone3,post,department,email,qq,weixin,nextlinkdate,nextcallrecordid,validate,remark,company,createtime,createman,modifytime,modifyman,isdelete,flag,homeaddress,officeaddress,sex,fox)");
		...
		public FishEntity.CustomerEntity GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select id,code,name,currentlinkDate,telephone,phone1,phone2,phone3,post,department,email,qq,weixin,nextlinkdate,nextcallrecordid,validate,remark,company,createtime,createman,modifytime,modifyman,isdelete,flag,homeaddress,officeaddress,sex,fox  from t_customer ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
};
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select id,code,name,currentlinkDate,telephone,phone1,phone2,phone3,post,department,email,qq,weixin,nextlinkdate,nextcallrecordid,validate,remark,company,createtime,createman,modifytime,modifyman,isdelete,flag,homeaddress,officeaddress,sex,fox ");

    ...
    public class ProductDao
    {
		...
		public int Add(FishEntity.ProductEntity model)
		{
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@factoryaddress", MySqlDbType.VarChar,100),
		...
		public bool Update(FishEntity.ProductEntity model)
		{
			...
			parameters[23].Value = model.createman;
			parameters[24].Value = model.modifyman;
			parameters[25].Value = model.isdelete;
			parameters[26].Value = model.suppliercode;
			parameters[27].Value = model.supplier;
			parameters[28].Value = model.quote_protein;
			parameters[29].Value = model.quote_tvn;
			parameters[30].Value = model.quote_graypart;
			parameters[31].Value = model.quote_sandsalt;
			parameters[32].Value = model.quote_amine;
			parameters[33].Value = model.quote_ffa;
			parameters[34].Value = model.quote_fat;
			parameters[35].Value = model.quote_water;
			parameters[36].Value = model.quote_sand;
			parameters[37].Value = model.sgs_protein;
			parameters[38].Value = model.sgs_tvn;
			parameters[39].Value = model.sgs_graypart;
			parameters[40].Value = model.sgs_sandsalt;
			parameters[41].Value = model.sgs_amine;
			parameters[42].Value = model.sgs_ffa;
            parameters[43].Value = model.sgs_fat;
			parameters[44].Value = model.sgs_water;
			parameters[45].Value = model.sgs_sand;
			parameters[46].Value = model.label_protein;
			parameters[47].Value = model.label_tvn;
			parameters[48].Value = model.label_graypart;
			parameters[49].Value = model.label_sandsalt;
			parameters[50].Value = model.label_amine;
			parameters[51].Value = model.label_ffa;
			parameters[52].Value = model.label_fat;
			parameters[53].Value = model.labe_water;
			parameters[54].Value = model.label_sand;
			parameters[55].Value = model.label_lysine;
			parameters[56].Value = model.label_methionine;
			parameters[57].Value = model.domestic_protein;
			parameters[58].Value = model.domestic_tvn;
			parameters[59].Value = model.domestic_graypart;
			parameters[60].Value = model.domestic_sandsalt;
			parameters[61].Value = model.domestic_sour;
			parameters[62].Value = model.domestic_lysine;
			parameters[63].Value = model.domestic_methionine;
            parameters[64].Value = model.arriveportdate;
            parameters[65].Value = model.productdate;
            parameters[66].Value = model.shelflife;
            parameters[67].Value = model.getinfotime;
            parameters[68].Value = model.endinfotime;
            parameters[69].Value = model.supplierid;
            parameters[70].Value = model.linkmanid;
            parameters[71].Value = model.linkmancode;
            parameters[72].Value = model.linkman;
            parameters[73].Value = model.latestquote;

            parameters[74].Value = model.goodsinfo;
            parameters[75].Value = model.shipno;
            parameters[76].Value = model.cornerno;
            parameters[77].Value = model.tariffrate;
            parameters[78].Value = model.samplingtime;
            parameters[79].Value = model.warehouse;
            parameters[80].Value = model.sgsweight;
            parameters[81].Value = model.sgsquantity;
            parameters[82].Value = model.domestic_amine;
            parameters[83].Value = model.domestic_aminototal;
            parameters[84].Value = model.domestic_fat;

			parameters[85].Value = model.id;
		...
		public FishEntity.ProductEntity GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select id,code,name,brand,state,nature,origin,type,getinfotime,endinfotime,techtype,specification,productdate,shelflife,quality,manufacturers,factoryaddress,remark,weight,quantity,remainweight,remainquantity,homemadeweight,homemadepackages,homemadecost,homemadeunitprice,price,arriveportdate,sailingschedule,ownerCode,ownershortname,ownername,billofgoods,agentifcompany,customsofcompany,createtime,createman,modifytime,modifyman,isdelete,suppliercode,supplier,quote_protein,quote_tvn,quote_graypart,quote_sandsalt,quote_amine,quote_ffa,quote_fat,quote_water,quote_sand,sgs_protein,sgs_tvn,sgs_graypart,sgs_sandsalt,sgs_amine,sgs_ffa, sgs_fat,sgs_water,sgs_sand,label_protein,label_tvn,label_graypart,label_sandsalt,label_amine,label_ffa,label_fat,labe_water,label_sand,label_lysine,label_methionine,domestic_protein,domestic_tvn,domestic_graypart,domestic_sandsalt,domestic_sour,domestic_lysine,domestic_methionine,supplierid,linkmanid,linkmancode,linkman,latestquote ,goodsinfo,shipno,cornerno,tariffrate,samplingtime,warehouse,sgsweight,sgsquantity,domestic_amine,domestic_aminototal,domestic_fat from t_product ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select id,code,name,brand,state,nature,origin,type,getinfotime,endinfotime,techtype,specification,productdate,shelflife,quality,");
            ...
            strSql.Append(" sailingschedule, billofgoods,agentifcompany,customsofcompany,createtime,createman,modifytime,modifyman, isdelete,");

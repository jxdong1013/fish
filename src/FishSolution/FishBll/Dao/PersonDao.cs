...
namespace FishBll.Dao
{
    public  class PersonDao
    {
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,username,password,realname,ename,sex,email,phone,telephone,age,department,entrytime,roletype,roledate,createtime,createman,modifytime,modifyman,isdelete ");

...
namespace FishBll.Dao
{
    public class CallRecordsDao
    {
        ...
        public List<FishEntity.CallRecordsEntity> QueryCallRecordsTable(string where)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            strSql.Append(" , max(currentdate) as  maxcurrentdate , max(nextdate) as maxnextdate from t_callrecords ");
